...
(1) NOT NULL,
  ...
  `FirstName` longtext CHARACTER
SET utf8mb4
COLLATE utf8mb4_0900_ai_ci,
  `LastName` longtext CHARACTER
SET utf8mb4
COLLATE utf8mb4_0900_ai_ci,
  PRIMARY KEY
(`Id`),
...
COLLATE utf8mb4_0900_ai_ci,
  ...
  `VerticalOrientation` tinyint
(1) NOT NULL,
  `RoomId` int NOT NULL,
  PRIMARY KEY
(`Id`),
  KEY `IX_Tables_RoomId`
(`RoomId`),
  CONSTRAINT `FK_Tables_Rooms_RoomId` FOREIGN KEY
